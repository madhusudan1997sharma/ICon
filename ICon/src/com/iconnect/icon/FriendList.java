...
import com.iconnect.icon.types.STATUS;

public class FriendList extends ListActivity
{
	private static final int PROFILE = Menu.FIRST;
	...
	{		
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.text.setText(friends[position].name);
	...
	private ServiceConnection mConnection = new ServiceConnection() {
		public void onServiceConnected(ComponentName className, IBinder service) {          
			...
			imService.getLastRawFriendList();
			if (friends != null) {    			
	...
	public void parseFriendInfo(String rawFriendList) {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		i.putExtra(FriendInfo.NAME, friend.name);
	...
	public boolean onCreateOptionsMenu(Menu menu) {		
		...
		menu.add(0, PROFILE, 0, "Profile");
		
		menu.add(0, EXIT_APP_ID, 0, R.string.menuItem_Exit);		
	...
	{		
		...
		{	  
			...
			case PROFILE:
			{
				Toast.makeText(FriendList.this, "Yet to be coded. :)", Toast.LENGTH_SHORT).show();
				return true;
			}
			case EXIT_APP_ID:
			{
