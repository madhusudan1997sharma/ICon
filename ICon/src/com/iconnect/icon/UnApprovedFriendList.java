...
public class UnApprovedFriendList extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		setTitle("Pending Friend Request(s)");
		...
		setListAdapter(new ArrayAdapter<String>(this,
                R.layout.friend_request_list, friendUsernames));
	...
	{		
		...
		{	  
			case APPROVE_SELECTED_FRIENDS_ID:
			{
				...
				Toast.makeText(UnApprovedFriendList.this, R.string.request_accepted, Toast.LENGTH_SHORT).show();
